...
- **Monetization**: Free | Bucks Practice Platform £24.99/mo (pack_monthly, TIER_RANK=1, limited: 6 Hard drills, no analytics/mocks) | Bucks Practice Platform Edge £59.99/mo (pack_plus) or £495/yr (pack_annual) — full platform | Bucks Young Scholar Programme £349 one-time (programme24_plus, 6 months, full platform). ALL three paid-full tiers share identical feature access: all Hard drills, mock exams, analytics, roadmap, milestone diagnostics, weekly plans. Difference is duration/price only. Legacy: pack12 £119, programme8 £59, programme12 £89, programme16 £249, programme16_family £349 — still valid, not shown on pricing page.
...
- **Upgrade path**: pack_monthly → [pack_plus, pack_annual, programme24_plus]; pack_plus → [pack_annual, programme24_plus]; pack_annual → [] (no upgrades — already has full access for 12 months)
