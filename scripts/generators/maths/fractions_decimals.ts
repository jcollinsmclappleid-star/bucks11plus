...
export function generateFractionDecimalQuestions(): GeneratedQuestion[] {
  ...
  const contextualFractionProblems: { prompt: string; correct: string; distractors: string[]; d: number; subRule: string; explanation: string }[] = [
    ...
    { prompt: 'A bottle holds 2/3 of a litre. Jack pours out 1/4 of a litre. What fraction of a litre remains?', correct: '5/12', distractors: ['1/3', '7/12', '3/7'], d: 2, subRule: 'maths.fractions.add_subtract', explanation: '2/3 − 1/4 = 8/12 − 3/12 = 5/12' },
    { prompt: 'There are 40 sweets in a bag. 3/5 are red and the rest are blue. How many blue sweets are there?', correct: '16', distractors: ['24', '8', '20'], d: 1, subRule: 'maths.fractions.of_amount', explanation: '3/5 × 40 = 24 red. 40 − 24 = 16 blue.' },
    { prompt: 'A field is 7/8 of an acre. A path covers 1/4 of the field. What fraction of an acre is the path?', correct: '7/32', distractors: ['1/4', '3/8', '2/8'], d: 3, subRule: 'maths.fractions.multiply', explanation: '1/4 × 7/8 = 7/32' },
    { prompt: 'A runner completes 2/3 of a race on day one and 1/6 on day two. What fraction is left?', correct: '1/6', distractors: ['1/3', '2/6', '5/6'], d: 2, subRule: 'maths.fractions.add_subtract', explanation: '2/3 + 1/6 = 4/6 + 1/6 = 5/6 done. Left: 6/6 − 5/6 = 1/6' },
    { prompt: 'There are 48 pupils in a year group. 5/8 of them play a musical instrument. How many play an instrument?', correct: '30', distractors: ['24', '36', '40'], d: 2, subRule: 'maths.fractions.of_amount', explanation: '5/8 × 48 = 30' },
    { prompt: 'A wall is 3/4 painted. An additional 1/8 is painted the next day. What fraction is now painted?', correct: '7/8', distractors: ['4/12', '1/2', '3/8'], d: 1, subRule: 'maths.fractions.add_subtract', explanation: '3/4 + 1/8 = 6/8 + 1/8 = 7/8' },
    { prompt: 'A box weighs 5/6 of a kilogram. If 1/3 of the contents is removed, what is the weight of the contents removed?', correct: '5/18', distractors: ['1/2', '2/6', '5/9'], d: 3, subRule: 'maths.fractions.multiply', explanation: '1/3 × 5/6 = 5/18 kg removed' },
  ];
