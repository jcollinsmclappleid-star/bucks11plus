...
export function generateFractionDecimalQuestions(): GeneratedQuestion[] {
  ...
  const contextualFractionProblems: { prompt: string; correct: string; distractors: string[]; d: number; subRule: string; explanation: string }[] = [
    ...
    { prompt: 'A jar of sweets is 3/4 full. After taking some, it is 1/4 full. What fraction of the sweets were taken?', correct: '1/2', distractors: ['2/4', '1/4', '3/4'], d: 1, subRule: 'maths.fractions.add_subtract', explanation: '3/4 − 1/4 = 2/4 = 1/2' },
    { prompt: 'A jug is 5/6 full of water. 1/6 of the water is poured out. What fraction of the jug is still full?', correct: '2/3', distractors: ['4/6', '1/3', '5/6'], d: 1, subRule: 'maths.fractions.add_subtract', explanation: '5/6 − 1/6 = 4/6 = 2/3' },
    ...
    { prompt: 'A farmer uses 2/5 of his land for wheat. He uses 3/4 of the wheat field for a new variety. What fraction of the total land is the new variety?', correct: '3/10', distractors: ['5/9', '6/20', '2/4'], d: 2, subRule: 'maths.fractions.multiply', explanation: '3/4 × 2/5 = 6/20 = 3/10' },
    ...
    { prompt: 'A school has 120 pupils. 2/5 of them walk to school. How many pupils walk to school?', correct: '48', distractors: ['24', '60', '40'], d: 2, subRule: 'maths.fractions.of_amount', explanation: '2/5 × 120 = 48' },
    { prompt: 'A book has 180 pages. James has read 5/6 of it. How many pages has he read?', correct: '150', distractors: ['160', '140', '120'], d: 2, subRule: 'maths.fractions.of_amount', explanation: '5/6 × 180 = 150' },
    ...
    { prompt: 'A tank holds 60 litres when full. It is 7/10 full. How many more litres are needed to fill it?', correct: '18', distractors: ['42', '12', '24'], d: 2, subRule: 'maths.fractions.of_amount', explanation: 'Currently: 7/10 × 60 = 42 litres. Needed: 60 − 42 = 18 litres' },
    { prompt: 'Sophie spends 1/3 of her pocket money on a book and 1/4 on a drink. What fraction of her pocket money does she spend altogether?', correct: '7/12', distractors: ['2/7', '1/6', '5/12'], d: 2, subRule: 'maths.fractions.add_subtract', explanation: '1/3 + 1/4 = 4/12 + 3/12 = 7/12' },
  ...
  const decConvConfigs: { prompt: string; frac: string; decimal: string; d: number }[] = [
    ...
    { prompt: 'A runner has completed 1/5 of a race. What fraction is this as a decimal?', frac: '1/5', decimal: '0.2', d: 1 },
    { prompt: 'A jar is 2/5 full. What is this as a decimal?', frac: '2/5', decimal: '0.4', d: 1 },
