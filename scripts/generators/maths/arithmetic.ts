...
function easyAdditionProblems(): WordProblem[] {
  return [
    ...
    {
      prompt: 'A baker makes 26 bread rolls in the morning and 38 in the afternoon. How many bread rolls does he make altogether?',
      correct: 64, traps: [12, 63, 54],
      explanation: '26 + 38 = 64 bread rolls.',
      difficulty: 'easy', subRuleId: 'maths.arithmetic.addition',
      trapTypes: ['wrong_operation', 'off_by_one'], distractorStyleId: 'wrong_operation',
      contextId: 'baking', cognitiveLoad: 1, estTimeSeconds: 20,
    },
    {
      prompt: 'There are 47 red marbles and 35 blue marbles in a jar. How many marbles are there in total?',
      correct: 82, traps: [12, 81, 72],
      explanation: '47 + 35 = 82 marbles.',
      difficulty: 'easy', subRuleId: 'maths.arithmetic.addition',
      trapTypes: ['wrong_operation', 'off_by_one'], distractorStyleId: 'wrong_operation',
      contextId: 'everyday', cognitiveLoad: 1, estTimeSeconds: 20,
    },
    {
      prompt: 'A gardener plants 54 tulips and 28 daffodils. How many flowers does she plant altogether?',
      correct: 82, traps: [26, 81, 72],
      explanation: '54 + 28 = 82 flowers.',
      difficulty: 'easy', subRuleId: 'maths.arithmetic.addition',
      trapTypes: ['wrong_operation', 'off_by_one'], distractorStyleId: 'wrong_operation',
      contextId: 'gardening', cognitiveLoad: 1, estTimeSeconds: 20,
    },
    {
      prompt: 'A baker makes 125 bread rolls in the morning and 87 in the afternoon. How many rolls does he make in total?',
      correct: 212, traps: [38, 202, 222],
      explanation: '125 + 87 = 212 rolls.',
      difficulty: 'medium', subRuleId: 'maths.arithmetic.addition',
      trapTypes: ['wrong_operation', 'off_by_one'], distractorStyleId: 'wrong_operation',
      contextId: 'baking', cognitiveLoad: 1, estTimeSeconds: 25,
    },
    {
      prompt: 'On a school trip, there are 38 pupils from Year 5 and 42 pupils from Year 6. How many pupils are on the trip?',
      correct: 80, traps: [4, 70, 90],
      explanation: '38 + 42 = 80 pupils.',
      difficulty: 'easy', subRuleId: 'maths.arithmetic.addition',
      trapTypes: ['wrong_operation', 'off_by_one'], distractorStyleId: 'wrong_operation',
      contextId: 'school', cognitiveLoad: 1, estTimeSeconds: 20,
    },
    {
      prompt: 'A factory produces 346 items on Monday and 289 on Tuesday. How many items were produced over both days?',
      correct: 635, traps: [57, 625, 645],
      explanation: '346 + 289 = 635 items.',
      difficulty: 'medium', subRuleId: 'maths.arithmetic.addition',
      trapTypes: ['wrong_operation', 'off_by_one'], distractorStyleId: 'wrong_operation',
      contextId: 'work', cognitiveLoad: 2, estTimeSeconds: 30,
    },
    {
      prompt: 'A theatre has 256 seats on the ground floor and 178 seats in the balcony. How many seats are there in total?',
      correct: 434, traps: [78, 424, 444],
      explanation: '256 + 178 = 434 seats.',
      difficulty: 'medium', subRuleId: 'maths.arithmetic.addition',
      trapTypes: ['wrong_operation', 'off_by_one'], distractorStyleId: 'wrong_operation',
      contextId: 'entertainment', cognitiveLoad: 2, estTimeSeconds: 30,
    },
    {
      prompt: 'A school collected 1,245 books and then received a donation of 678 more. How many books does the school have now?',
      correct: 1923, traps: [567, 1913, 1933],
      explanation: '1,245 + 678 = 1,923 books.',
      difficulty: 'hard', subRuleId: 'maths.arithmetic.addition',
      trapTypes: ['wrong_operation', 'off_by_one'], distractorStyleId: 'wrong_operation',
      contextId: 'school', cognitiveLoad: 3, estTimeSeconds: 35,
    },
  ];
}
...
function easySubtractionProblems(): WordProblem[] {
  return [
    ...
    {
      prompt: 'A shop has 93 oranges. 47 oranges are sold during the day. How many oranges are left?',
      correct: 46, traps: [140, 56, 43],
      explanation: '93 − 47 = 46 oranges left.',
      difficulty: 'easy', subRuleId: 'maths.arithmetic.subtraction',
      trapTypes: ['wrong_operation', 'off_by_one'], distractorStyleId: 'wrong_operation',
      contextId: 'shopping', cognitiveLoad: 1, estTimeSeconds: 20,
    },
    {
      prompt: 'There are 65 children at a party. 29 children go home early. How many children are still at the party?',
      correct: 36, traps: [94, 46, 34],
      explanation: '65 − 29 = 36 children remaining.',
      difficulty: 'easy', subRuleId: 'maths.arithmetic.subtraction',
      trapTypes: ['wrong_operation', 'off_by_one'], distractorStyleId: 'wrong_operation',
      contextId: 'everyday', cognitiveLoad: 1, estTimeSeconds: 20,
    },
    {
      prompt: 'A box contains 84 crayons. 36 crayons are broken. How many crayons are not broken?',
      correct: 48, traps: [120, 58, 46],
      explanation: '84 − 36 = 48 crayons not broken.',
      difficulty: 'easy', subRuleId: 'maths.arithmetic.subtraction',
      trapTypes: ['wrong_operation', 'off_by_one'], distractorStyleId: 'wrong_operation',
      contextId: 'classroom', cognitiveLoad: 1, estTimeSeconds: 20,
    },
    {
      prompt: 'A farmer has 250 sheep. He sells 78 at market. How many sheep does he have left?',
      correct: 172, traps: [328, 182, 162],
      explanation: '250 − 78 = 172 sheep.',
      difficulty: 'medium', subRuleId: 'maths.arithmetic.subtraction',
      trapTypes: ['wrong_operation', 'off_by_one'], distractorStyleId: 'wrong_operation',
      contextId: 'farming', cognitiveLoad: 2, estTimeSeconds: 25,
    },
    {
      prompt: 'A library has 430 books. 156 are borrowed. How many books remain on the shelves?',
      correct: 274, traps: [586, 284, 264],
      explanation: '430 − 156 = 274 books.',
      difficulty: 'medium', subRuleId: 'maths.arithmetic.subtraction',
      trapTypes: ['wrong_operation', 'off_by_one'], distractorStyleId: 'wrong_operation',
      contextId: 'library', cognitiveLoad: 2, estTimeSeconds: 25,
    },
    {
      prompt: 'A train can carry 520 passengers. If 347 passengers board, how many empty seats are there?',
      correct: 173, traps: [867, 163, 183],
      explanation: '520 − 347 = 173 empty seats.',
      difficulty: 'medium', subRuleId: 'maths.arithmetic.subtraction',
      trapTypes: ['wrong_operation', 'off_by_one'], distractorStyleId: 'wrong_operation',
      contextId: 'transport', cognitiveLoad: 2, estTimeSeconds: 25,
    },
    {
      prompt: 'A supermarket has 1,000 tins of beans. 462 are sold. How many tins remain?',
      correct: 538, traps: [1462, 548, 528],
      explanation: '1,000 − 462 = 538 tins.',
      difficulty: 'medium', subRuleId: 'maths.arithmetic.subtraction',
      trapTypes: ['wrong_operation', 'off_by_one'], distractorStyleId: 'wrong_operation',
      contextId: 'shopping', cognitiveLoad: 2, estTimeSeconds: 25,
    },
    {
      prompt: 'An aeroplane is flying at 8,500 metres. It descends 2,750 metres. What is its new altitude?',
      correct: 5750, traps: [11250, 5850, 5650],
      explanation: '8,500 − 2,750 = 5,750 metres.',
      difficulty: 'hard', subRuleId: 'maths.arithmetic.subtraction',
      trapTypes: ['wrong_operation', 'off_by_one'], distractorStyleId: 'wrong_operation',
      contextId: 'transport', cognitiveLoad: 3, estTimeSeconds: 30,
    },
  ];
}
...
function easyMultDivProblems(): WordProblem[] {
  return [
    ...
    {
      prompt: 'A box holds 9 eggs. A farmer has 7 boxes. How many eggs does the farmer have?',
      correct: 63, traps: [16, 56, 72],
      explanation: '9 × 7 = 63 eggs.',
      difficulty: 'easy', subRuleId: 'maths.arithmetic.multiplication',
      trapTypes: ['wrong_operation', 'times_table_error'], distractorStyleId: 'times_table_error',
      contextId: 'farming', cognitiveLoad: 1, estTimeSeconds: 20,
    },
    {
      prompt: '42 sweets are shared equally among 7 children. How many sweets does each child get?',
      correct: 6, traps: [7, 5, 49],
      explanation: '42 ÷ 7 = 6 sweets each.',
      difficulty: 'easy', subRuleId: 'maths.arithmetic.division',
      trapTypes: ['off_by_one'], distractorStyleId: 'off_by_one',
      contextId: 'sharing', cognitiveLoad: 1, estTimeSeconds: 20,
    },
    {
      prompt: 'There are 4 shelves in a bookcase. Each shelf has 11 books. How many books are there in total?',
      correct: 44, traps: [15, 40, 48],
      explanation: '4 × 11 = 44 books.',
      difficulty: 'easy', subRuleId: 'maths.arithmetic.multiplication',
      trapTypes: ['wrong_operation', 'times_table_error'], distractorStyleId: 'times_table_error',
      contextId: 'library', cognitiveLoad: 1, estTimeSeconds: 20,
    },
    {
      prompt: 'A ticket costs £7. How much do 9 tickets cost?',
      correct: 63, traps: [16, 56, 72],
      explanation: '7 × 9 = £63.',
      difficulty: 'easy', subRuleId: 'maths.arithmetic.multiplication',
      trapTypes: ['times_table_error'], distractorStyleId: 'times_table_error',
      contextId: 'entertainment', cognitiveLoad: 1, estTimeSeconds: 20,
    },
    {
      prompt: 'A car park has 15 rows with 12 spaces in each row. How many spaces are there?',
      correct: 180, traps: [27, 170, 190],
      explanation: '15 × 12 = 180 spaces.',
      difficulty: 'medium', subRuleId: 'maths.arithmetic.multiplication',
      trapTypes: ['wrong_operation', 'times_table_error'], distractorStyleId: 'times_table_error',
      contextId: 'transport', cognitiveLoad: 2, estTimeSeconds: 25,
    },
    {
      prompt: '72 children are split into groups of 8. How many groups are there?',
      correct: 9, traps: [8, 10, 64],
      explanation: '72 ÷ 8 = 9 groups.',
      difficulty: 'easy', subRuleId: 'maths.arithmetic.division',
      trapTypes: ['off_by_one'], distractorStyleId: 'off_by_one',
      contextId: 'school', cognitiveLoad: 1, estTimeSeconds: 20,
    },
    {
      prompt: 'A rope is 96 cm long. It is cut into 8 equal pieces. How long is each piece?',
      correct: 12, traps: [88, 11, 13],
      explanation: '96 ÷ 8 = 12 cm.',
      difficulty: 'easy', subRuleId: 'maths.arithmetic.division',
      trapTypes: ['off_by_one'], distractorStyleId: 'off_by_one',
      contextId: 'measurement', cognitiveLoad: 1, estTimeSeconds: 20,
    },
    {
      prompt: 'A shop has 144 eggs. They are packed in boxes of 12. How many boxes are needed?',
      correct: 12, traps: [132, 11, 13],
...
function mediumBodmasContextProblems(): WordProblem[] {
  return [
    ...
    {
      prompt: 'A classroom has 6 rows of 5 desks. Each desk has 3 drawers. How many drawers are there in total?',
      correct: 90, traps: [30, 11, 18],
      explanation: '6 × 5 = 30 desks. 30 × 3 = 90 drawers.',
      difficulty: 'medium', subRuleId: 'maths.arithmetic.bodmas',
      trapTypes: ['partial_calculation', 'wrong_operation'], distractorStyleId: 'partial_calculation',
      contextId: 'classroom', cognitiveLoad: 2, estTimeSeconds: 35,
    },
    {
      prompt: 'Tom has 48 stickers. He gives 8 to each of his 4 friends and keeps the rest. How many does he keep?',
      correct: 16, traps: [32, 40, 12],
      explanation: '8 × 4 = 32 given away. 48 − 32 = 16 kept.',
      difficulty: 'medium', subRuleId: 'maths.arithmetic.bodmas',
      trapTypes: ['partial_calculation'], distractorStyleId: 'partial_calculation',
      contextId: 'everyday', cognitiveLoad: 2, estTimeSeconds: 30,
    },
    {
      prompt: 'A bus carries 52 passengers. At the first stop, 17 get off and 9 get on. How many passengers are on the bus now?',
      correct: 44, traps: [26, 78, 35],
      explanation: '52 − 17 = 35. Then 35 + 9 = 44.',
      difficulty: 'medium', subRuleId: 'maths.arithmetic.bodmas',
      trapTypes: ['partial_calculation', 'wrong_operation'], distractorStyleId: 'partial_calculation',
      contextId: 'transport', cognitiveLoad: 2, estTimeSeconds: 30,
    },
    {
      prompt: 'A shop sells 15 oranges at 40p each and 20 apples at 30p each. What is the total in pounds?',
      correct: 12, traps: [6, 35, 10.5],
      explanation: '15 × 40p = 600p = £6. 20 × 30p = 600p = £6. Total = £12.',
      difficulty: 'medium', subRuleId: 'maths.arithmetic.bodmas',
      trapTypes: ['partial_calculation'], distractorStyleId: 'partial_calculation',
      contextId: 'shopping', cognitiveLoad: 2, estTimeSeconds: 35, isMoney: true,
    },
...
function easyTimeProblems(): WordProblem[] {
  return [
    ...
    {
      prompt: 'A lesson starts at 11:20 am and lasts for 50 minutes. What time does the lesson end?',
      correct: 1210, traps: [1170, 1220, 1200],
      explanation: '11:20 am + 50 minutes = 12:10 pm.',
      difficulty: 'easy', subRuleId: 'maths.arithmetic.addition',
      trapTypes: ['time_calculation_error'], distractorStyleId: 'time_error',
      contextId: 'time', cognitiveLoad: 1, estTimeSeconds: 25,
    },
    {
      prompt: 'A train departs at 14:05 and arrives at 15:25. How many minutes is the journey?',
      correct: 80, traps: [120, 70, 90],
      explanation: 'From 14:05 to 15:25 = 1 hour 20 minutes = 80 minutes.',
      difficulty: 'easy', subRuleId: 'maths.arithmetic.subtraction',
      trapTypes: ['time_calculation_error'], distractorStyleId: 'time_error',
      contextId: 'time', cognitiveLoad: 1, estTimeSeconds: 25,
    },
    {
      prompt: 'Ella reads for 40 minutes each evening. How many minutes does she read in 5 evenings?',
      correct: 200, traps: [180, 160, 250],
      explanation: '40 × 5 = 200 minutes.',
      difficulty: 'easy', subRuleId: 'maths.arithmetic.multiplication',
      trapTypes: ['wrong_multiplier'], distractorStyleId: 'wrong_multiplier',
      contextId: 'time', cognitiveLoad: 1, estTimeSeconds: 20,
    },
