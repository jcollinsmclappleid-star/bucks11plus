...
export function generateWordProblemQuestions(): GeneratedQuestion[] {
  ...
  const multiStepProblems: { prompt: string; correct: string; distractors: string[]; d: number }[] = [
    ...
    { prompt: 'A train travels 85 kilometres in the first hour and 72 kilometres in the second hour. If it needs to cover 250 kilometres in total, how many more kilometres must it travel?', correct: '93', distractors: ['157', '178', '165'], d: 3 },
    ...
    { prompt: 'A school has 28 classrooms. Each classroom has 6 rows of desks with 5 desks in each row. How many desks are there in total?', correct: '840', distractors: ['168', '140', '870'], d: 3 },
    { prompt: 'A farmer has 360 litres of milk. He uses 45 litres each day. After 6 days, how many litres remain?', correct: '90', distractors: ['270', '315', '135'], d: 3 },
  ...
  const moneyProblems: { prompt: string; correct: string; distractors: string[]; d: number }[] = [
    ...
    { prompt: 'A family of 2 adults and 3 children visit a museum. Adult tickets cost £12.50 and child tickets cost £7.25. What is the total cost?', correct: '£46.75', distractors: ['£45.75', '£39.50', '£59.25'], d: 3 },
  ...
  const timeProblems: { prompt: string; correct: string; distractors: string[]; d: number }[] = [
    ...
    { prompt: 'A football match starts at 15:00 and has two 45-minute halves with a 15-minute break. What time does it finish?', correct: '16:45', distractors: ['16:30', '17:00', '16:15'], d: 3 },
