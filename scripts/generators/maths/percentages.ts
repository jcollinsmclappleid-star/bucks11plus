...
export function generatePercentageQuestions(): GeneratedQuestion[] {
  ...
  for (const c of findConfigs) {
    ...
    questions.push({
      ...
      distractorStyleId: 'decimal_point', contextId: 'percentages',
  ...
  for (const c of incDecConfigs) {
    ...
    questions.push({
      ...
      distractorStyleId: 'increase_vs_decrease', contextId: 'percentages',
  ...
  for (const c of reverseConfigs) {
    ...
    questions.push({
      ...
      distractorStyleId: 'reverse_pct', contextId: 'percentages',
