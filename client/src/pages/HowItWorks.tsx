  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The readiness check is a timed GL-style assessment covering Verbal Reasoning, Non-Verbal Reasoning, Mathematics, and English Comprehension. It measures your child's accuracy and pacing across all four domains and returns a practice score on the 121 scale for Buckinghamshire grammar school preparation."
      }
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "There are three readiness bands: Secure (Green) — practice score on the 121 scale is consistently at or above 121; Borderline (Amber) — close to 121 but with identifiable risk factors; Development Required (Red) — a measurable gap exists between the current practice score and 121."
      }
    },
    {
      "@type": "Question",
            ...
            {[
              {
                ...
                points: [
                  ...
                  "Receive a practice score on the 121 scale",
        ...
        <div className="container mx-auto max-w-4xl px-4">
            ...
            {[
              {
                ...
                desc: "A practice score on the 121 scale — showing how close your child is to 121 and how many points remain.",
              },
              {
                icon: BarChart3,
                iconBg: "bg-violet-100 text-violet-700",
                title: "Readiness band (Green / Amber / Red)",
                desc: "An at-a-glance status: On Track (Green), Borderline (Amber), or Development Required (Red) — based on the practice score on the 121 scale.",
              },
              {
                icon: Zap,
          ...
          <div className="rounded-2xl border border-slate-200 bg-white overflow-hidden shadow-sm">
            ...
            <div className="divide-y divide-slate-50">
              {[
                { band: "Secure", color: "bg-emerald-500", textColor: "text-emerald-700", bg: "bg-emerald-50", desc: "Practice score on the 121 scale is consistently at or above 121 across accuracy, pacing and sub-skill balance. The child is on track under current conditions." },
                { band: "Borderline", color: "bg-amber-500", textColor: "text-amber-700", bg: "bg-amber-50", desc: "Practice score is close to 121 but shows identifiable risk factors such as pacing instability or concentrated weaknesses. Targeted practice in the priority areas will close the gap." },
                { band: "Development Required", color: "bg-red-500", textColor: "text-red-700", bg: "bg-red-50", desc: "The practice score sits noticeably below 121. Structured, focused preparation is needed — the programme will prioritise the highest-impact areas first." },
              ].map((b, i) => (
        ...
        <div className="container mx-auto max-w-3xl px-4">
          ...
          <div className="space-y-3">
            {[
              ...
              { icon: Layers, title: "Sub-skill stability", content: "Reaching 121 requires balanced competency across domains. Significant imbalance between VR, NVR and Maths reduces the stability weighting. Repeated weaknesses within a single sub-rule cluster are treated as higher risk than isolated errors." },
              ...
              { icon: Shield, title: "Composite readiness index", content: "All factors combine into a weighted composite index — Accuracy, Pace, Sub-skill Stability, and Consistency — that maps to a readiness band and a practice score on the 121 scale. This is designed to reflect practical exam performance, not the theoretical maximum, and is not a substitute for the official GL standardised score." },
            ].map((item, i) => (
