    ...
    privacy: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: "Bucks 11 Plus Tests is designed exclusively for parents and guardians to use on behalf of their child. The account holder must be a parent or legal guardian aged 18 or over; we do not provide accounts directly to children. By creating a child profile, you confirm you are the parent or legal guardian of that child and that you consent — as the holder of parental responsibility under Article 8 of the UK GDPR — to our processing of your child's first name, age, year group and assessment performance for the purpose of providing the educational service. We collect the minimum data needed to deliver the Service. We do not use any child's data for marketing, advertising, profiling for advertising, or behavioural advertising. We do not share child data with any third party for their own purposes. You can update, export or delete your child's data at any time from your Account Settings, and deleting your account immediately removes every linked child profile, session and answer."
        },
        {
        ...
        },
        {
          ...
          body: "Active accounts: we keep your personal data for as long as you have an active subscription or are actively using the free tier. Once your subscription has ended (or if you have only ever used the free tier), we keep your account so you can return — for example for a sibling, or in the next exam cycle — for 24 months from your last sign-in. After 24 months of inactivity with no active subscription, an automated process permanently deletes your account, child profiles, test sessions, answers and email history. We chose 24 months because it covers the typical Year 4 → Year 5 → Year 6 family cycle without holding data longer than necessary. Specific data types: password-reset tokens expire automatically after 1 hour; email delivery logs are auto-deleted after 12 months; payment and tax records remain in Stripe for the period required by HMRC (currently 6 years), which is Stripe's responsibility as the regulated payment processor. Account closure: if you delete your account from the Account Settings page (or by emailing us), all account, child profile, session and answer data is removed immediately, and any active subscription is cancelled with Stripe at the same time. Anonymised aggregates that cannot be linked back to you may be retained for the purpose of improving our readiness models."
        },
        {
