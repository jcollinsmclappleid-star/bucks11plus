...
export default function About() {
  return (
    <div className="container mx-auto max-w-4xl px-4 py-16 prose prose-slate prose-lg">
      <Seo
        title="About | Bucks 11 Plus Diagnostic & Preparation Platform | Bucks 11 Plus Tests"
        description="Bucks 11 Plus Tests is an independent Bucks 11 Plus platform helping parents understand their child's readiness, identify weak areas, and prepare more effectively for the 121 standard."
        canonicalPath="/about"
      />
      ...
      <p className="text-xl text-muted-foreground lead">
        We built Bucks 11 Plus Tests to give every child preparing for the Buckinghamshire 11+ the clearest possible picture of where they stand — and exactly what needs to happen next to give them the best chance at 121.
      </p>
      ...
      <p>
        By then, there is nothing left to do. Bucks 11 Plus Tests exists to make sure that moment never comes as a surprise.
      </p>

      <h2 className="text-primary font-serif">Our Approach</h2>
      <p>
        Bucks 11 Plus Tests is an assessment-first platform. Practice without direction is wasted time — so we start with a diagnostic that measures not just accuracy, but pacing: whether your child is working at the speed the real test demands, and where within each subject the gaps are concentrated.
      </p>
      <p>
      ...
      <ul>
        ...
        <li>It works well alongside a tutor. Many families use Bucks 11 Plus Tests to fill the hours between tutoring sessions with directed, evidence-backed practice.</li>
        ...
        <div className="rounded-2xl border border-slate-200 bg-slate-50 overflow-hidden">
          ...
          <div className="px-7 py-6 space-y-5">
            <p className="text-slate-700 leading-relaxed">
              Bucks 11 Plus Tests is operated by <strong className="text-primary">Ianson Systems Limited</strong>, a UK-based company that develops educational tools and diagnostic assessment platforms to support 11+ preparation.
            </p>
            ...
            <p className="text-xs text-slate-400 leading-relaxed border-t border-slate-200 pt-4">
              Bucks 11 Plus Tests is an independent platform. Ianson Systems Limited has no affiliation with GL Assessment, Buckinghamshire Council, The Buckinghamshire Grammar Schools (TBGS), or any individual grammar school.
            </p>
          </div>
        </div>
      </div>
