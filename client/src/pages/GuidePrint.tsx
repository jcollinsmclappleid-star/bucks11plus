    ...
    <div className="guide-print bg-white text-slate-800 font-sans max-w-[210mm] mx-auto">
      ...
      <div className="page-break">
        ...
        <div className="grid grid-cols-2 gap-3 text-sm">
          {[
            { icon: "🎯", title: "Free 8-Minute Readiness Check", desc: "Assess all four subjects, get a practice score on the 121 scale, and receive specific improvement priorities. No account needed." },
            ...
            { icon: "⏱️", title: "Readiness Checks", desc: "Full 40-question timed readiness checks with audio-style pacing and a practice score on the 121 scale." },
          ...
          {[
            {
              ...
              features: [
                ...
                "Practice score on the 121 scale",
            ...
            },
            {
              ...
              price: "£279",
              sub: "per year · save £141 vs monthly · equiv. £23.25/mo · 34% off",
              color: "emerald",
              accent: "#059669",
              badge: "BEST VALUE",
              features: [
              ...
              url: `${BASE}/pricing`,
              urlLabel: "Get Annual Access — £279",
            },
