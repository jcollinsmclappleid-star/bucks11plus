...
const sections: LinkSection[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { title: "Familiarisation Test Explained", description: "What the official Bucks 11+ familiarisation test is, what it tells you, and what it cannot tell you about your child's readiness.", href: "/bucks-11-plus-familiarisation-test" },
      { title: "Mock Tests — When and Why", description: "How a properly constructed mock test differs from practice papers, when to sit one, and how to interpret the results.", href: "/bucks-11-plus-mock-test" },
      { title: "Vocabulary List by Tier", description: "150 high-utility 11+ vocabulary words organised across foundation, intermediate and stretch tiers, plus how vocabulary is tested.", href: "/bucks-11-plus-vocabulary-list" },
      { title: "Test Day Checklist", description: "Practical guide to test day — what to bring, what to wear, what to eat, and how to keep the morning calm.", href: "/bucks-11-plus-test-day-checklist" },
      { title: "Bucks vs CEM vs Kent 11+", description: "How the main UK 11+ variants differ in producer, format, threshold, and preparation approach — and which test your area uses.", href: "/bucks-11-plus-vs-cem-vs-kent" },
      { title: "Cost of Preparation", description: "What Bucks 11+ preparation actually costs in 2026 — tutors, online platforms, books, and self-study compared honestly.", href: "/bucks-11-plus-tuition-cost" },
      { title: "Frequently Asked Questions", description: "The most common parent questions about the test, the qualifying score, registration, preparation and grammar school allocation.", href: "/bucks-11-plus-faqs" },
  ...
  },
  {
    ...
    links: [
      ...
      { title: "South Buckinghamshire Grammar Schools", description: "Cluster guide to the six grammar schools serving High Wycombe, Marlow, Beaconsfield and Burnham — catchments and competitive landscape.", href: "/south-bucks-grammar-schools" },
      { title: "Aylesbury Vale Grammar Schools", description: "Cluster guide to the four grammar schools serving Aylesbury, Wendover and Buckingham — catchments and admissions context.", href: "/aylesbury-vale-grammar-schools" },
      { title: "Chiltern Grammar Schools", description: "Cluster guide to the three Chiltern grammar schools serving Amersham and Chesham — catchments, competitive picture and preparation.", href: "/chiltern-grammar-schools" },
    ],
  },
  {
