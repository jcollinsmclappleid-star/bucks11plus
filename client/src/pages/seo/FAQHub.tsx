...
const faqSections: FAQSection[] = [
  ...
  },
  {
    ...
    questions: [
      { question: "What is included in the free plan?", answer: "An 8-minute readiness check producing a practice score on the 121 scale, a section breakdown across all four GL Assessment domains, and the three highest-impact priorities to fix next. Free users can also access our parent guides and learning resources." },
      ...
      { question: "How is your scoring different from raw practice paper percentages?", answer: "We show a practice score on the 121 scale, not a raw percentage. The score accounts for question difficulty and your child's pacing on GL-style questions. It is an independent practice indicator — not an official standardised score. Percentages on practice papers don't translate directly to 121-scale numbers, so our score is more useful for tracking preparation progress." },
