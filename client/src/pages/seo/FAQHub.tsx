...
const faqSections: FAQSection[] = [
  ...
  },
  {
    ...
    questions: [
      { question: "What is included in the free plan?", answer: "An 8-minute readiness check producing an indicative readiness score against the 121 qualifying standard, a section breakdown across all four GL Assessment domains, and the three highest-impact priorities to fix next. Free users can also access our parent guides and learning resources." },
      ...
      { question: "How is your scoring different from raw practice paper percentages?", answer: "We produce an indicative readiness score against the 121 qualifying standard, not a percentage. The forecast accounts for question difficulty and your child's pacing on GL-style questions. It is an indicator, not an official standardised score — only the actual GL Assessment applies official age-standardised scoring tables. Percentages on practice papers don't translate directly to the 121 scale, so an indicative readiness score is more useful for tracking preparation." },
