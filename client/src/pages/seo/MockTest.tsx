  ...
  return (
    <div className="container mx-auto max-w-4xl px-4 py-16 prose prose-slate prose-lg">
      ...
      <div className="not-prose overflow-x-auto my-8">
        <table className="w-full text-sm border-collapse" data-testid="table-mock-vs-practice">
          ...
          <tbody>
            ...
            <tr className="border-b border-slate-100"><td className="p-3 font-medium">Scoring</td><td className="p-3 text-slate-600">Raw mark or percentage</td><td className="p-3 text-slate-600">Standardised forecast vs 121</td></tr>
      ...
      <ul>
        ...
        <li><strong>A standardised forecast score</strong> against the 121 threshold — not just a percentage</li>
      ...
      <p>
        Our paid plans include full-length GL-style mock exams across all four domains, sat under proper timed conditions, with standardised forecast scoring against the 121 threshold. Each mock produces a section breakdown, a pacing analysis, a stamina report, and a ranked list of the highest-impact gaps to address before the next mock.
      </p>
      <p>
