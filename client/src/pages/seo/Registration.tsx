  ...
  return (
    <div className="container mx-auto max-w-4xl px-4 py-16 prose prose-slate prose-lg">
      ...
      <div className="not-prose mb-8 border-l-4 border-primary bg-primary/[0.03] rounded-r-xl pl-7 pr-6 py-6">
        <h1 className="text-4xl md:text-5xl font-bold text-primary font-serif tracking-tight mb-3" data-testid="heading-registration">
      ...
      <p>
        To understand exactly where your child currently stands, take our <Link href="/free-diagnostic" className="text-primary hover:underline">free 8-minute diagnostic</Link>. It measures accuracy and pacing across all four domains and provides a realistic forecast against the 121 qualifying benchmark.
      </p>
