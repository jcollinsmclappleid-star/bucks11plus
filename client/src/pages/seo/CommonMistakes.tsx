...
export default function CommonMistakes() {
  return (
    <div className="container mx-auto max-w-4xl px-4 py-16 prose prose-slate prose-lg">
      ...
      <p>
        <strong>What to do instead:</strong> Learn how standardised scoring works. Understand that raw scores on practice papers are indicative but not directly comparable to the 121 readiness benchmark. Use assessment tools that provide an indicative readiness score against 121 rather than simple percentage scores. Read our detailed <Link href="/bucks-11-plus-qualifying-score" className="text-primary hover:underline">qualifying score explanation</Link> for a full breakdown.
      </p>
