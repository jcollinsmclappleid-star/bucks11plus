...
export default function Pricing() {
  ...
  return (
    <div className="flex flex-col min-h-[calc(100vh-4rem)]">
      ...
      {/* ── HERO ── */}
      <section className="relative overflow-hidden pt-12 pb-14 md:pt-16 md:pb-18 border-b border-border/50" style={{ backgroundColor: '#0d1f30' }} data-testid="section-hero">
          ...
          {hasPaidPlan ? (
            <>
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-white font-serif mb-4">
                {isTopTier ? "Your full access plan is active." : "Your plan is active. Save £71 by switching to Annual."}
              </h1>
              <p className="text-white/60 mb-7">
                {currentTier === "pack_annual"
                  ...
                  : "You have full monthly access. Switch to Annual for £349/year and save £71 on your current billing."}
              </p>
        ...
        <div className="container mx-auto max-w-5xl px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-xl mx-auto">
              {hasPaidPlan
                ? (isTopTier ? "You have full access to the most comprehensive preparation package." : "You're on monthly. Switch to Annual and save £71.")
        ...
        <section className="py-12 bg-amber-50 border-b border-brand-amber/20" id="upgrade" data-testid="section-upgrade">
          <div className="container mx-auto max-w-xl px-4 text-center">
            <div className="inline-flex items-center gap-2 bg-brand-amber/10 border border-brand-amber/30 rounded-full px-4 py-1.5 mb-4">
              ...
              <span className="text-xs font-bold uppercase tracking-wider text-brand-amber">Save £71</span>
            </div>
            <h3 className="text-2xl font-bold text-primary font-serif mb-3">Switch to Annual and save £71</h3>
            <p className="text-slate-600 text-sm mb-6">You're on monthly billing at £35/month. Switch to Annual for £349/year — identical access, 12 months locked in, £71 saved.</p>
