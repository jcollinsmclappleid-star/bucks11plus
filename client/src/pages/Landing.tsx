...
export default function Landing() {
  ...
  return (
    <div className="flex flex-col min-h-[calc(100vh-4rem)]">
      ...
      <section className="py-20 md:py-28 bg-slate-50 border-b border-border/30" id="how-forecast-works">
        <div className="container mx-auto max-w-6xl px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold text-primary font-serif mb-4" data-testid="text-showcase-title">
              What you'll see in your dashboard
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Real-time insights that show exactly where your child stands and how to close the gap.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-12 gap-12 items-start">
              ...
              {showcaseTabs.map((tab) => (
                <button
                  ...
                  className={`w-full text-left p-5 rounded-2xl transition-all duration-300 border-2 ${
                    activeTab === tab.id
                      ? "bg-white border-brand-amber shadow-md translate-x-2"
                      : "bg-transparent border-transparent text-slate-500 hover:bg-white/50"
                  }`}
                  data-testid={`button-tab-${tab.id}`}
                >
                  <span className={`block text-sm font-bold uppercase tracking-wider mb-1 ${activeTab === tab.id ? "text-brand-amber" : "text-slate-400"}`}>
                    Insight {showcaseTabs.indexOf(tab) + 1}
                  </span>
                  <span className={`text-xl font-bold font-serif ${activeTab === tab.id ? "text-primary" : "text-slate-600"}`}>
                    {tab.label}
                  </span>
                </button>
              ))}
            ...
            <div className="lg:col-span-8">
              <div className="bg-white rounded-3xl border border-slate-200 shadow-xl p-8 md:p-12 min-h-[500px] flex items-center justify-center relative overflow-hidden">
                <div className="absolute top-0 right-0 -mr-16 -mt-16 w-64 h-64 bg-brand-amber/5 rounded-full blur-3xl"></div>
                <div className="absolute bottom-0 left-0 -ml-16 -mb-16 w-64 h-64 bg-blue-50 rounded-full blur-3xl"></div>
      ...
      <section className="py-24 md:py-32 bg-slate-50 overflow-hidden border-b border-border/30" id="how-forecast-works">
        <div className="container mx-auto max-w-6xl px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold text-primary font-serif mb-4" data-testid="text-showcase-title">
              What you'll see in your dashboard
      ...
      <section className="py-20 bg-white border-b border-border/50">
        <div className="container mx-auto max-w-6xl px-4 text-center">
          <h2 className="text-3xl font-bold text-primary font-serif mb-6">Want to see more?</h2>
          <p className="text-lg text-muted-foreground mb-10 max-w-2xl mx-auto">
            Our platform provides depth that workbooks simply can't match. Every diagnostic is a step towards total clarity.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <Button size="lg" className="bg-brand-amber hover:bg-brand-amber/90" asChild>
              <Link href="/pricing">View Plans & Enrol</Link>
            </Button>
