      ...
      >
        ...
        <div className="text-sm text-blue-900 leading-relaxed">
          ...
          <p className="mt-1.5">
            ...
            <Link href="/how-forecast-works" className="underline font-medium" data-testid="link-scoring-methodology-block">
  ...
  return (
    ...
    >
      ...
      <p>
        ...
        <Link href="/how-forecast-works" className="underline" data-testid="link-scoring-methodology-inline">
