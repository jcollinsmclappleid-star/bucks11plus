  ...
  return (
    ...
    >
      ...
      <p className="mt-3 pt-3 border-t border-white/60 text-[10px] text-muted-foreground">
        Bucks Plus Edge · 2,500+ GL-style questions like this
      </p>
    </div>
  );
}
...
export function SampleQuestionsCarousel({ className, showLabel = true }: SampleQuestionsCarouselProps) {
  ...
  return (
    <div className={cn("relative max-w-full overflow-hidden", className)}>
      <div
        ref={scrollRef}
        className="flex gap-4 overflow-x-auto overscroll-x-contain pb-3 snap-x snap-mandatory min-w-0 max-w-full"
