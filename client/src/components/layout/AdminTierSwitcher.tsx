...
const TIERS = [
  ...
  { value: "pack_monthly", label: "Practice Platform · £59.99/mo", color: "bg-blue-100 text-blue-800" },
  { value: "pack_annual", label: "Practice Platform Annual · £495/yr", color: "bg-blue-200 text-blue-900" },
