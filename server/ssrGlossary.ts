...
export const GLOSSARY_TERMS: GlossaryTerm[] = [
  ...
  },
  {
    ...
    faq: [
      { question: "How can my child practise with audio instructions?", answer: "Some 11+ preparation platforms (including Bucks 11 Plus Tests) offer audio-format mock tests that replicate the recorded voice experience. CGP also produces audio CD practice packs. Any timed mock test should ideally be run with audio instructions so children experience the format before test day." },
    ],
  },
  {
