...
<p>Arrive early but not too early. Have a calm breakfast routine. Avoid last-minute revision. Remind your child that they have prepared well and this is their chance to show what they know.</p>`,
  ...
  await db.insert(practiceSections).values([
    ...
    { title: "Letter Sequences", category: "Verbal Reasoning", icon: "Type", difficulty: "Hard", questionCount: 12, requiredTier: "programme16", skillId: "vr.sequences" },
    ...
    { title: "Code Breaking", category: "Verbal Reasoning", icon: "Lock", difficulty: "Hard", questionCount: 12, requiredTier: "programme16", skillId: "vr.codes" },
    ...
    { title: "Advanced Transformations", category: "Non-Verbal Reasoning", icon: "Layers", difficulty: "Hard", questionCount: 12, requiredTier: "programme16", skillId: "nvr.transform" },
    ...
    { title: "Classification Challenge", category: "Non-Verbal Reasoning", icon: "Shapes", difficulty: "Hard", questionCount: 12, requiredTier: "programme16", skillId: "nvr.classification" },
    ...
    { title: "Advanced Arithmetic", category: "Mathematics", icon: "Calculator", difficulty: "Hard", questionCount: 12, requiredTier: "programme16", skillId: "maths.arithmetic" },
    { title: "Multi-step Word Problems", category: "Mathematics", icon: "Brain", difficulty: "Hard", questionCount: 12, requiredTier: "programme16", skillId: "maths.word_problems" },
