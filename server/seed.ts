...
<p>Arrive early but not too early. Have a calm breakfast routine. Avoid last-minute revision. Remind your child that they have prepared well and this is their chance to show what they know.</p>`,
  ...
  await db.insert(practiceSections).values([
    ...
    { title: "Advanced Word Analogies", category: "Verbal Reasoning", icon: "BookOpen", difficulty: "Hard", questionCount: 12, requiredTier: "pack12", skillId: "vr.vocab" },
    ...
    { title: "Advanced Hidden Words", category: "Verbal Reasoning", icon: "Search", difficulty: "Hard", questionCount: 12, requiredTier: "pack12", skillId: "vr.word_structure" },
    ...
    { title: "Advanced Logical Deduction", category: "Verbal Reasoning", icon: "GitBranch", difficulty: "Hard", questionCount: 12, requiredTier: "pack12", skillId: "vr.verbal_logic" },
    ...
    { title: "Advanced Word Classification", category: "Verbal Reasoning", icon: "List", difficulty: "Hard", questionCount: 10, requiredTier: "pack12", skillId: "vr.word_sequences" },
    ...
    { title: "Advanced Symmetry", category: "Non-Verbal Reasoning", icon: "Maximize2", difficulty: "Hard", questionCount: 12, requiredTier: "pack12", skillId: "nvr.symmetry" },
    ...
    { title: "Complex Sequences", category: "Non-Verbal Reasoning", icon: "Waypoints", difficulty: "Hard", questionCount: 12, requiredTier: "pack12", skillId: "nvr.sequence" },
    ...
    { title: "Advanced Fractions", category: "Mathematics", icon: "Percent", difficulty: "Hard", questionCount: 10, requiredTier: "pack12", skillId: "maths.fractions" },
    ...
    { title: "Advanced Data Interpretation", category: "Mathematics", icon: "BarChart3", difficulty: "Hard", questionCount: 10, requiredTier: "pack12", skillId: "maths.data" },
    ...
    { title: "Advanced Number Patterns", category: "Mathematics", icon: "TrendingUp", difficulty: "Hard", questionCount: 10, requiredTier: "pack12", skillId: "maths.patterns" },
    ...
    { title: "Advanced Percentages", category: "Mathematics", icon: "BadgePercent", difficulty: "Hard", questionCount: 10, requiredTier: "pack12", skillId: "maths.percentages" },
    ...
    { title: "Advanced Ratio & Proportion", category: "Mathematics", icon: "Scale", difficulty: "Hard", questionCount: 10, requiredTier: "pack12", skillId: "maths.ratio" },
  ]);
